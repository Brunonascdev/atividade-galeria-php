...
<html lang="pt-BR">
  ...
  <body>
    <div class="container">
      ...
      <p></p>
      <h4><img src="icons/arrow-left.svg" width="46" height="46" title="Voltar" onclick="location.href='albuns.php'"> Álbum: <?php echo $album; ?></h4>
      <hr>
      <div class="row">      
        <?php
          $path = "albuns/". $album ."";
            ...
            foreach ($x as $key => $value) {
                    if ('.' !== $value && '..' !== $value){
                      // if ($value !== ''){
                        echo "<div class='col-md-4'><div class='card'><img src='". $path . "/" .$value."' class='card-img-top'><div class='card-body'><p class='card-text'>". $value ."</p></div></div></div><br>";
                      // }                                    
              }
            }
         ?>        
